...
import { setLanguage as setI18nLanguage, getCurrentLanguage, resolveLanguage } from './utils/i18n';
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        const lang = (saved ? resolveLanguage(saved) : getCurrentLanguage()) as Language;
        setLanguage(lang);
